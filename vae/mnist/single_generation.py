...
run = mlflow.start_run(
    experiment_id=experiment.experiment_id, run_name=f"single_digit_{DIGIT}"
)
...
random_indices = [np.where(labels == DIGIT)[0][:10]] * N_SAMPLES
...
original_images = dataset.data[random_indices]
